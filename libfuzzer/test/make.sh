...
#
# See http://llvm.org/docs/LibFuzzer.html for more fine tuning
#
...
CC=clang++-3.9
XSAN="-fsanitize=address -fsanitize-coverage=trace-cmp -fsanitize=undefined -fno-sanitize-recover=undefined -fsanitize-coverage=edge"
